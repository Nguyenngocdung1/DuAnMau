        ...
        <div class="">
          <?php 
            ...
            <div class="form-groud d-flex mb-2 align-items-center">
              ...
              <input style="width: 100px;" value="1" class="form-control" type="number" min="1" name="quantity['.$id.']" size="2" id="">
            </div>
        ...
        while ($row8 = $in_comment->fetch_assoc()) {
          ...
          echo '<div class="comment_item d-flex container ps-4">
            <div class="comment_left me-2">
              <img class="mt-1" style="object-fit: cover;" height="60px" width="60px" src="./admin/light-bootstrap-dashboard-master/examples/images/user/' . $user_img . '" alt="">
            </div>
          ...
          if ($result10->num_rows > 0) {
            while ($row10 = $result10->fetch_assoc()) {
              ...
              echo '<div class="comment_item d-flex container" style="padding: 10px 0 10px 85px;">
                  <div class="comment_left me-2">
                  <img class="mt-1" width="60px" style="object-fit: cover;" height="60px" src="./admin/light-bootstrap-dashboard-master/examples/images/user/' . $user_img . '" alt="">
                  </div>
                  <div class="comment_right">';
              if ($user_admin == 1) {
                echo '<h5>Admin</h5>';
